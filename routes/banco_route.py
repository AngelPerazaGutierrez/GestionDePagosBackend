...
@banco.put("/editar-banco/{banco_nit}", response_model=GestionDePagosBackend.config.schemas.banco_schema.Banco)
async def editar_banco(banco_nit: int, banco: GestionDePagosBackend.config.schemas.banco_schema.Banco,
